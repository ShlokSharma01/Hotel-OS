        ...
        {billing && (
          <FadeIn delay={0.1}>
            ...
            <div style={{ background: 'var(--navy-800)', border: '1px solid var(--border)', borderRadius: 20, padding: 28, marginBottom: 20 }}>
              <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 16, marginBottom: 20, color: '#94a3b8', letterSpacing: '0.04em', textTransform: 'uppercase', fontSize: 11 }}>Stay Summary</h2>
              {[
